...
function App() {
  ...
  const [originalImageUrl, setOriginalImageUrl] = useState(IMAGE_INFO[0].originalImageUrl);
  const [depthImageUrl, setDepthImageUrl] = useState(IMAGE_INFO[0].depthImageUrl);
